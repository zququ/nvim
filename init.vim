...
" Author: @theniceboy
" Modify by @Zququ for mac normal keyboard user
...
let g:VM_maps["Undo"]      = '<c-h>'
let g:VM_maps["Redo"]      = '<C-r>'
let g:VM_maps["Select All"]      = ',k'
let g:VM_maps["Visual All"]      = ',k'
...
"Make ctags universal-ctags for mac
...
" === fzf-gitignore
" ===
noremap <LEADER>gi :silent! FzfGitignore<CR>
...
"
"Solve the 'nvr' problem by install vim-remote
...
augroup calendar-mappings
	...
	autocmd FileType calendar nmap <buffer> u <Plug>(calendar_start_insert)
	autocmd FileType calendar nmap <buffer> U <Plug>(calendar_start_insert_head)
